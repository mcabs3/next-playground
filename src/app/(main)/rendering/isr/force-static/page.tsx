	...
	return (
		<>
			...
			<PageContent>
				...
				<p>
					This page data fetches a random pokemon using
					https://pokeapi.co/api/v2. By default, the fetch does not leverage any
					caching mechanics so this will opt this page into being a dynamic
					route. We can leverage exporting <code>revaliate</code> and{" "}
					<code>dynamic = "force-static"</code> to tell the page to cache the
					data calls (the pokemon call) to the time value (seconds).
				</p>
