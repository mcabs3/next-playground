		...
		<>
			...
			<PageContent>
				...
				<p>
					...
					non-generated but accepted paths. <code>true (default)</code> will
					allow this page to be handles as a dynamic route (SSR), and{" "}
					<code>false</code> will direct the app to the not found.
				</p>
