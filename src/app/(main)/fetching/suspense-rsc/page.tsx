...
`}
			...
			<PageContent>
				...
				<p>
					...
					into async Server Components and wrap them with Suspense. Static
					content renders immediately while dynamic parts stream in as their
					data resolves.
				</p>
				...
				<p>
					...
					, this pattern keeps the page function synchronous. Data fetching
					moves into child components that are wrapped with Suspense boundaries:
				</p>
				...
				<ul className="list-disc space-y-2 pl-6">
					...
					<li>
						<strong>Independent streaming</strong> - Each Suspense boundary
						streams its content as soon as its data is ready.
					</li>
				</ul>
...
`}
				...
				<ul className="list-disc space-y-2 pl-6">
					...
					<li>
						...
						becomes available. Fast APIs don't wait for slow ones.
					</li>
					<li>
					...
					<li>
						<strong>Automatic request deduplication</strong> - React
						automatically deduplicates identical fetch requests across
						components.
					</li>
				</ul>
				...
				<blockquote data-level="success">
					...
					<p className="mt-2">
						This pattern is essential for PPR. The static shell can be
						prerendered at build time, while dynamic components stream in at
						request time—all in a single HTTP response.
					</p>
				</blockquote>
...
`}
				...
				<ul className="list-disc space-y-2 pl-6">
					...
					<li>
						<strong>Consider grouping related content</strong> - If two pieces
						of data always load together, they can share a Suspense boundary.
					</li>
					<li>
				...
				<ul className="list-disc space-y-2 pl-6">
					...
					<li>
						<strong>Important static content</strong> - When headers,
						navigation, or key content should appear instantly.
					</li>
					<li>
						<strong>Dashboard-style pages</strong> - Multiple independent
						widgets that can load in parallel.
					</li>
				</ul>
