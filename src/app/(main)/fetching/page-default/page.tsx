...
`}
			...
			<ul className="list-inside list-disc space-y-4 not-italic">
				<li>
					...
					<code>Promise.all</code>, but <b>boundary</b> blocking still applies.
					Your <code>Page</code> cannot render until the promises resolve. The
					recommended approach is to move data fetching to a child RSC to move
					the <b>boundary</b> lower in the page tree.{" "}
					<Link
				...
				<li>
					...
					&quot;hang&quot; 👎 as it waits for the data to load. You should avoid
					this by introducing a page-level <code>loading.tsx</code> to provide
				...
				<li>
					...
					requires the page to be an async component. Instead it is preferred to
					pass the params to child components that consume the params.
				</li>
			</ul>
		</main>
	);
